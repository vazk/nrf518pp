...
uint32_t nrfpp_sd_ble_gap_device_name_set(ble_gap_conn_sec_mode_t const* const p_write_perm,
                                         uint8_t const                * const p_dev_name,
                                         uint16_t                             len);

uint32_t nrfpp_sd_ble_gap_ppcp_set(ble_gap_conn_params_t const* const p_conn_params);

uint32_t nrfpp_sd_ble_gap_adv_start(ble_gap_adv_params_t const* const p_adv_params);

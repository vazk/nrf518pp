...
uint32_t nrfx_sd_ble_gap_device_name_set(ble_gap_conn_sec_mode_t const* const write_perm,
...
uint32_t nrfx_sd_ble_gap_ppcp_set(ble_gap_conn_params_t const* const conn_params)
{
    return sd_ble_gap_ppcp_set(conn_params);
}


uint32_t nrfx_sd_ble_gap_adv_start(ble_gap_adv_params_t const* const adv_params)
{
